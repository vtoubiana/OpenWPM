...
def run_site_crawl(db_path, sites, preferences, dump_location):
    ...
    for browser_index in range(0, num_browser):
		#manager.exelate_settings(50,'f',i)
		#manager.google_settings(True,i)
    ...
    # set_google_settings(age, gender, language, interests, webdriver, browser_params):
    """for site in sites:
        print "test"
        manager.exelate_settings(50,i)
    ...
    if dump_location:
        manager.dump_profile(dump_location,True,None,6000)"""
